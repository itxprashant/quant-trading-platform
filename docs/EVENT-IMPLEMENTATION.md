...
- **Bonds:** Standard costs $10,000 and pays $500 per five game minutes. Pegged coupon is `(2000 - AERIUM market price) / 10`, including negative yields. Both face values and the otherwise unspecified pegged purchase price default to $10,000; purchases are limited to one lifetime purchase of each type per player.
