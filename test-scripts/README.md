...
Black-box scripts that hit the deployed Quantstorm stack (`https://quanta.devclub.in` by default). They check trader, admin, and New Eden challenge features, plus auth, matching, WebSocket fan-out, rate limits, and edge cases.
